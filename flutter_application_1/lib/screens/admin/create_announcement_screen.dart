        ...
        child: DropdownButtonFormField<String>(
          ...
          items: _isLoadingSites
              ...
              : _assignedSites.map((site) {
                  final isAllSites = site['id'] == 'all';
                  final subtitle = isAllSites ? 'Visible to everyone' : site['code'];
                  return DropdownMenuItem<String>(
                    value: site['id'] as String,
                    child: Text(
                      isAllSites ? '${site['name']} ($subtitle)' : '${site['name']} ($subtitle)',
                      style: TextStyle(
                        fontWeight: FontWeight.w500,
                        fontSize: 14,
                        color: isAllSites ? AppColors.primary : null,
                      ),
